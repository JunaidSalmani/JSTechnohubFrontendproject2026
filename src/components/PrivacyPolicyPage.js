  ...
  return (
    <div className="privacy-container">
      <div className="privacy-content">
        ...
        <p>
          Welcome to <strong>JSTechnoHub</strong> ("we", "our", "us"). We are
          committed to protecting your privacy. This Privacy Policy explains how
          we collect, use, disclose, and safeguard your information when you
          visit our website and use our coaching services (collectively, the
          "Services").
        </p>
        ...
        <ul>
          <li>
            ...
            voluntarily give to us when you fill out a contact form, purchase a
            service, or otherwise contact us.
          </li>
          <li>
            ...
            brand, expiration date) that our payment processor (Razorpay)
            collects when you purchase a service. We do not store any financial
        ...
        <ul>
          ...
          <li>
            Process your payments and deliver the services you have purchased.
          </li>
          <li>Communicate with you regarding your account or services.</li>
          <li>Respond to your inquiries and support needs.</li>
          <li>
            Send you promotional emails about new services, special offers, or
            other information we think you may find interesting (where you have
            consented to this).
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            on our behalf, including payment processing (Razorpay), data
        ...
        <p>
          ...
          certain processing of your data. To make such a request, please use
